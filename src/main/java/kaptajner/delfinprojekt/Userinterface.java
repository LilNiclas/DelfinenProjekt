    ...
    public int validateInt(){
        ...
        do {
            try {
                ...
                System.out.println("WrIting error, try agaian.");
                writingError = true;
            }
        } while (writingError);
        return 0;
        ...
        public void createResult () {
            ...
            if (menu == 1) {
                ...
                controller.createPracticeResult(timeResult, isPractice, disciplin, date, membershipNumber);
